...
Vendored from wespeaker.models.ecapa_tdnn (pip package) so this training
pipeline doesn't break on a `wespeaker` package upgrade -- same convention
as wespeaker_campplus.py / wespeaker_samresnet.py in this directory.
'''

import torch
import torch.nn as nn
import torch.nn.functional as F
import wespeaker_pooling_layers as pooling_layers
