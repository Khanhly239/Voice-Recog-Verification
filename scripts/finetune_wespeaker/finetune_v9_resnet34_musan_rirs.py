...
CKPT_DIR = "C:/Lily/voiceKYC/pretrained_models/wespeaker_resnet34_v9_musan_rirs_cosface"
...
def main():
    train_dataset = CombinedSpeakerDatasetResNet(max_utts_per_spk_en=MAX_UTTS_PER_SPK_EN, musan_rirs=True)
    ...
    print(f"\nKet qua cuoi cung (v9: ResNet34 + MUSAN/RIRS + CosFace + EN/VI combined): "
          f"best_top5={best_top5*100:.2f}% (v8 nhieu Gaussian best=92.82%)")
