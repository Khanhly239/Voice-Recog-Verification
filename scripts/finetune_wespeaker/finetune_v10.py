# -*- coding: utf-8 -*-
"""v10 = cau hinh tot nhat (v8) + 3 sua doi:
...
CKPT_DIR = "C:/Lily/voiceKYC/pretrained_models/wespeaker_resnet34_v10"
...
def main():
    train_dataset = CombinedSpeakerDatasetV10(musan_rirs=True,
